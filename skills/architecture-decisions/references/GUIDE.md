...
This guide provides comprehensive documentation for the **architecture-decisions** skill in the custom-plugin-software-architect plugin.
...
```bash
# Invoke the skill
claude "architecture-decisions - [your task description]"

# Example
claude "architecture-decisions - analyze the current implementation"
```
...
def implement_architecture_decisions(input_data):
    """
    Implement architecture-decisions functionality.
