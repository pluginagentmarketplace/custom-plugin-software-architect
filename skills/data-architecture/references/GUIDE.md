...
This guide provides comprehensive documentation for the **data-architecture** skill in the custom-plugin-software-architect plugin.
...
```bash
# Invoke the skill
claude "data-architecture - [your task description]"

# Example
claude "data-architecture - analyze the current implementation"
```
...
def implement_data_architecture(input_data):
    """
    Implement data-architecture functionality.
