...
This guide provides comprehensive documentation for the **cloud-architecture** skill in the custom-plugin-software-architect plugin.
...
```bash
# Invoke the skill
claude "cloud-architecture - [your task description]"

# Example
claude "cloud-architecture - analyze the current implementation"
```
...
def implement_cloud_architecture(input_data):
    """
    Implement cloud-architecture functionality.
