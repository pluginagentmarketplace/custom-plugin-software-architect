...
This guide provides comprehensive documentation for the **architecture-documentation** skill in the custom-plugin-software-architect plugin.
...
```bash
# Invoke the skill
claude "architecture-documentation - [your task description]"

# Example
claude "architecture-documentation - analyze the current implementation"
```
...
def implement_architecture_documentation(input_data):
    """
    Implement architecture-documentation functionality.
