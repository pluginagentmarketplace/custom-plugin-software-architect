...
This guide provides comprehensive documentation for the **technical-leadership** skill in the custom-plugin-software-architect plugin.
...
```bash
# Invoke the skill
claude "technical-leadership - [your task description]"

# Example
claude "technical-leadership - analyze the current implementation"
```
...
def implement_technical_leadership(input_data):
    """
    Implement technical-leadership functionality.
