...
This guide provides comprehensive documentation for the **enterprise-patterns** skill in the custom-plugin-software-architect plugin.
...
```bash
# Invoke the skill
claude "enterprise-patterns - [your task description]"

# Example
claude "enterprise-patterns - analyze the current implementation"
```
...
def implement_enterprise_patterns(input_data):
    """
    Implement enterprise-patterns functionality.
